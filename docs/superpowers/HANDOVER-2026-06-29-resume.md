...
- File structure per architecture spec §5.2 (provider service / core client / types / widget / index ModuleProvider / **tests** / README), using the `.js`-extension + `providers/<name>/index.ts` packaging pattern.
